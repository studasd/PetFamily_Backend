...
using AutoFixture;
using PetFamily.IntegrationTests;
...
public class UpdatePetStatusHandlerTests : IClassFixture<IntegrationTestsWebFactory>, IAsyncLifetime
{
    private readonly IServiceScope scope;
    private readonly WriteDbContext db;
    private readonly ICommandHandler<Guid, UpdatePetStatusCommand> sut;
    ...
    public UpdatePetStatusHandlerTests(IntegrationTestsWebFactory factory)
    {
        ...
        sut = scope.ServiceProvider.GetRequiredService<ICommandHandler<Guid, UpdatePetStatusCommand>>();
        fixture = new Fixture();
        fixture.Customize<DateOnly>(c => c.FromFactory(() => DateOnly.FromDateTime(DateTime.Now)));
    }

    [Fact]
    public async Task HandleAsync_ValidCommand_Should_Update_Pet_Status()
    {
        // arrange
        ...
        var command = fixture.CreateUpdatePetStatusCommand(volunteerId, petId, PetHelpStatuses.NeedsHelp);
        ...
        pet!.HelpStatus.Should().Be(PetHelpStatuses.NeedsHelp);
    }
    ...
    public async Task HandleAsync_PetNotFound_Should_ReturnError()
    {
        ...
        var command = fixture.CreateUpdatePetStatusCommand(volunteerId, fakePetId, PetHelpStatuses.FoundHouse);
